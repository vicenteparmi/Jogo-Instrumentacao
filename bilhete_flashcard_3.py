...
config.output_file = "bilhete_flashcard_3"
config.disable_caching = True

class FlashcardLayout(Scene):
    """
    Generates flashcard 3/4 with code 432561
    """
    def construct(self):
        # Configurar fundo branco
        self.camera.background_color = WHITE
        
        # 1. Title - mudado para Bilhete 3/4
        title = Text("Bilhete 3/4", font_size=48, color=BLACK)
        ...
        # CÓDIGO ESPECÍFICO: 432561 - mapeando frequências na ordem correta
        code = [4, 3, 2, 5, 6, 1]
