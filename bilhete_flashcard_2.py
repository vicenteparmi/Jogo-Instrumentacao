...
config.output_file = "bilhete_flashcard_2"
config.disable_caching = True

class FlashcardLayout(Scene):
    """
    Generates flashcard 2/4 with code 613416
    """
    def construct(self):
        # Configurar fundo branco
        self.camera.background_color = WHITE
        
        # 1. Title - mudado para Bilhete 2/4
        title = Text("Bilhete 2/4", font_size=48, color=BLACK)
        ...
        # CÓDIGO ESPECÍFICO: 613416 - mapeando frequências na ordem correta
        code = [6, 1, 3, 4, 1, 6]
